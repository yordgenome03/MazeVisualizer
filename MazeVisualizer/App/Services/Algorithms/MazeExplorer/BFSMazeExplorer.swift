...
class BFSMazeExplorer: MazeExplorer {
    ...
    func initializeMazeData(name _: String, maze: [[MazeCellState]], algorithm _: String) -> (shortestPath: [MazePath], shortestDistance: Int) {
        let start = (1, 1)
